...
Version  : 1.9.5
Release  : 15
URL      : https://sourceforge.net/projects/doxygen/files/rel-1.9.5/doxygen-1.9.5.src.tar.gz
Source0  : https://sourceforge.net/projects/doxygen/files/rel-1.9.5/doxygen-1.9.5.src.tar.gz
...
%prep
%setup -q -n doxygen-1.9.5
cd %{_builddir}/doxygen-1.9.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662692936
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/doxygen-%{version}/libmscgen/COPYING %{buildroot}/usr/share/package-licenses/doxygen/bca27f784110bf4696bad645f60ee7361dd96ea7
pushd clr-build
%make_install
popd
