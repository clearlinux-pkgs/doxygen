...
Version  : 1.9.2
Release  : 13
URL      : https://sourceforge.net/projects/doxygen/files/rel-1.9.2/doxygen-1.9.2.src.tar.gz
Source0  : https://sourceforge.net/projects/doxygen/files/rel-1.9.2/doxygen-1.9.2.src.tar.gz
...
%prep
%setup -q -n doxygen-1.9.2
cd %{_builddir}/doxygen-1.9.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631924429
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/doxygen-1.9.2/LICENSE %{buildroot}/usr/share/package-licenses/doxygen/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/doxygen-1.9.2/addon/doxmlparser/LICENSE %{buildroot}/usr/share/package-licenses/doxygen/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/doxygen-1.9.2/libmscgen/COPYING %{buildroot}/usr/share/package-licenses/doxygen/bca27f784110bf4696bad645f60ee7361dd96ea7
pushd clr-build
%make_install
popd
